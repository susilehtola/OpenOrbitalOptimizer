...
| Type | Name |
| ---: | :--- |
|  Vector&lt; T &gt; | [**cg\_optimize**](#function-cg_optimize) (const Vector&lt; T &gt; & x0, const std::function&lt; std::pair&lt; T, Vector&lt; T &gt; &gt;(Vector&lt; T &gt;)&gt; & fx, T f\_tol=1e-8, T df\_tol=1e-6, T x\_tol=100 \*std::numeric\_limits&lt; T &gt;::epsilon(), size\_t max\_iter=1000) <br>_Conjugate gradient optimization._  |
